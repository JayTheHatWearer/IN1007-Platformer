...
public class LevelThree extends World {
    ...
    private void Populate() {
        ...
        defaultContainers[10].SetType("ground", 4);
        ...
        defaultContainers[16].SetType("corner", 9);
        ...
        defaultContainers[26].SetType("blank", 14);

        defaultContainers[27].setPosition(new Vec2(2.5f,-1.5f));
        defaultContainers[27].SetType("left-wall", 2);

        defaultContainers[28].setPosition(new Vec2(-0.5f,-4.5f));
        defaultContainers[28].SetType("roof", 8);

        defaultContainers[29].setPosition(new Vec2(-3.5f,-4.5f));
        defaultContainers[29].SetType("roof", 6);

        defaultContainers[30].setPosition(new Vec2(-9.5f,-1.5f));
        defaultContainers[30].SetType("roof", 2);

        defaultContainers[31].setPosition(new Vec2(-3.5f,-10.5f));
        defaultContainers[31].SetType("ground", 4);
        ...
        defaultContainers[57].setPosition(new Vec2(2.5f,-4.5f));
        defaultContainers[57].SetType("roof", 15);
        ...
        defaultContainers[60].setPosition(new Vec2(2f,1.5f));
